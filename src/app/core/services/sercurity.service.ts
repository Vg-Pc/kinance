...
export class SecurityService {
    ...
    public get(url: string, params?: any, submitButtonRef?: ElementRef, contentType?: string): Promise<any> {
        ...
        return this.http.get(appGlobal.baseSecurityApiUrl + url, { headers: this.headers })
            .toPromise()
            .then(res => {
                if (submitButtonRef != null) {
                    ld.stop();
    ...
    public post(url: string, data: any, submitButtonRef?: ElementRef, contentType?: string): Promise<any> {
        ...
        return this.http.post(appGlobal.baseSecurityApiUrl + url, this.parseDataContent(type, data), { headers: this.headers })
            .toPromise()
            .then(res => {
                if (submitButtonRef != null) {
                    ld.stop();
    ...
    public put(url: string, data: any, submitButtonRef?: ElementRef, contentType?: string): Promise<any> {
        ...
        return this.http.put(appGlobal.baseSecurityApiUrl + url, this.parseDataContent(type, data), { headers: this.headers })
            .toPromise()
            .then(res => {
                if (submitButtonRef != null) {
                    ld.stop();
    ...
    public delete(url: string, params?: any, submitButtonRef?: ElementRef, contentType?: string): Promise<any> {
        ...
        return this.http.delete(appGlobal.baseSecurityApiUrl + url, { headers: this.headers })
            .toPromise()
            .then(res => {
                if (submitButtonRef != null) {
                    ld.stop();
